...
const { createSubject, getAllSubject, getSubject, deleteSubject, getUserSubjects, getChaptersBySubjectSlug, getSubjectPdf } = require("../../controllers/educationController/SubjectController");
