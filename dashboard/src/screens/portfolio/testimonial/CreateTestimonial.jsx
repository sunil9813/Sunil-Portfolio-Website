    ...
    <>
      <StickyHeader>
        ...
        <div className="flexC gap-2">
          <GhostButton onClick={() => navigate("/testimonial")}>Cancel</GhostButton>
          <TertiaryButton onClick={handleCreate}>Submit</TertiaryButton>
        </div>
      </StickyHeader>
      <Wrapper className="p-5 mb-3">
        <div className="input">
      ...
      <section className="flex justify-between gap-3">
        <div className="w-2/3">
          <Wrapper className="p-5">
            ...
            <div className="input">
              ...
              <div className="relative">
                ...
                <div className="icon h-9 w-9 3xl:h-10 3xl:w-10 bg-blue-gray-300 rounded-full flexC text-white absolute top-1 left-1">
                  <BiPhoneCall size={18} />
                </div>
              </div>
            </div>
          ...
          {(type === "feedback" || type === "inquiry") && (
            <Wrapper className="p-5 py-7 mt-3">
              <div className="input">
                <div className="flex items-center gap-1">
                ...
                <div className="relative">
                  ...
                  <div className="icon h-9 w-9 3xl:h-10 3xl:w-10 bg-brown-300 rounded-full flexC text-white absolute top-1 left-1">
      ...
      {type === "feedback" && (
        <Wrapper className="p-5 w-full mb-5">
          <div className="input">
            <div className="flex items-center gap-1">
      ...
      {type === "inquiry" && (
        <>
          <Wrapper className="p-5 w-full mb-3">
            <div className="input">
              <div className="flex items-center gap-1">
