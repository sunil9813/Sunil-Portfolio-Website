...
import { Comments, FavoriteButton, HeadingThree, LikeButton, RichTextRenderer, Wrapper } from "@/routes";
...
export const ProjectDetails = () => {
  ...
  return (
    <>
      ...
      <section className="mt-6">{project?._id && <Comments resourceId={project._id} resourceType="Project" enableRating />} </section>
    </>
  );
};
