...
export const Input = ({ placeholder, type, value, name, handleChange, className, ...props }) => {
  return (
    <>
      <input
        {...props}
...
export const InputForResume = ({ placeholder, type, value, name, handleChange, className, ...props }) => {
  return (
    <>
      <input
        {...props}
