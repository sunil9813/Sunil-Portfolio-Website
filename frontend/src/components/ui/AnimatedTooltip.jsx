...
export const AnimatedTooltip = ({ items }) => {
  ...
  const translateX = useSpring(useTransform(x, [-10, 70], [-50, 50]), springConfig);
          ...
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item.id && (
              <MotionDiv
                ...
                className="absolute -top-12 z-50 flex  flex-col items-center justify-start rounded-md bg-black px-4 py-2 text-xs shadow-xl"
              >
