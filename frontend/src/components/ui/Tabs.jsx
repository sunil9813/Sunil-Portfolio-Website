...
export const Tabs = ({ tabs: propTabs, containerClassName, activeTabClassName, tabClassName, contentClassName }) => {
  ...
  return (
    <>
      <div className={cn("relative flexC overflow-auto sm:overflow-visible no-visible-scrollbar w-full", containerClassName)}>
      ...
      <FadeInDiv tabs={tabs} active={active} key={active.value} hovering={hovering} className={cn("mt-8", contentClassName)} />
    </>
  );
};
