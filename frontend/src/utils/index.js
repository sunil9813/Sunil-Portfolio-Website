...
export const getRandomTransform = () => {
  return {
    translateX: Math.random() * 30 - 50, // Random between -50px and 50px
    translateY: Math.random() * 40 - 20, // Random between -25px and 25px
    rotation: Math.random() * 180 - 60, // Random between -30deg and 30deg
    hoverTranslateX: Math.random() * 100 - 50,
    hoverTranslateY: Math.random() * 50 - 25,
    hoverRotation: Math.random() * 60 - 30,
  };
};
